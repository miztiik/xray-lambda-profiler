...
1. ## 🔬 Testing the solution
    ...
    - Use the `PolyglotServiceApiUrl` in the browser few times(x10)
        - You can also launch `cdk deploy locust-load-generator-stack` to generate load on your API automatically
    ...
    - Go to the AWS CloudWatch Dasboard to check the different metrics about the app
...
1. [Cfn Response](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cfn-lambda-function-code-cfnresponsemodule.html)
